package com.example.emu.deviceid.deviceid;
...
import com.example.emu.deviceid.BinderUtil;
...
public class IPhoneSubInfoUtil {
    ...
    private static final String TAG = IPhoneSubInfoUtil.class.getSimpleName();
