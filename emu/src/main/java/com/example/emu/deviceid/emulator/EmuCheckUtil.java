package com.example.emu.deviceid.emulator;
...
import com.example.emu.deviceid.ShellAdbUtils;
import com.example.emu.deviceid.deviceid.DeviceIdUtil;
import com.example.emu.deviceid.deviceid.IPhoneSubInfoUtil;
import com.example.emu.deviceid.deviceid.ITelephonyUtil;
...
public class EmuCheckUtil {
    ...
    public static boolean isEmulatorViaBuild(Context context) throws UnsatisfiedLinkError {
