...
#define LOGI(...) __android_log_print(ANDROID_LOG_ERROR, " ", __VA_ARGS__)
...
int a = -1;
int (*asmcheck)(void);
JNIEXPORT jboolean JNICALL Java_com_snail_antifake_jni_EmulatorDetectUtil_detect(JNIEnv *env, jobject jobject1)
{
    load(env);
    char code[] =
